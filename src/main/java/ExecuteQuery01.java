...
public class ExecuteQuery01 {
     ...
     //   while (resultSet.next()){
      ...
      //  }
       // System.out.println(countries);
        ...
        // Task 2: Get the country_name and country_id information from countries, which has region_id bigger than 3.
    ...
    //   while (resultSet2.next()){
     ...
     //   String query3 = "SELECT country_name, region_id FROM countries WHERE region_id > 3";
       // ResultSet resultSet3 = statement.executeQuery(query3);
        //boolean bool1 = statement.execute(query3);
        //System.out.println("Execute: "+bool1);
    ...
    //    }
        ...
        while (resultSet5.next()){
            ...
            int idOfCompany = resultSet5.getInt("company_id");
            System.out.println("Company id: "+ idOfCompany);

            String nameOfCompany = resultSet5.getString("company");
            System.out.println("Company Name: " + nameOfCompany);

            int numOfEmployees = resultSet5.getInt("number_of_employees");
            System.out.println("Number Of Employees: " + numOfEmployees);
